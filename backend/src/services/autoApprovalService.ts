...
export async function runAutoApproval() {
  ...
  for (const booking of pending) {
    try {
      ...
      const moveLabel = { MOVE_IN: 'Move In', MOVE_OUT: 'Move Out', DELIVERY: 'Delivery', RENO: 'Renovation', OPEN_HOUSE: 'Open House', FURNISHED_MOVE: 'Furnished Move', SUITCASE_MOVE: 'Suitcase Move' }[booking.moveType] ?? booking.moveType;
